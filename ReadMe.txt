...
Welcome to my machine learning portfolio: a collection of selected projects from selected machine-learning-related 
...
to implement them by hand i.e. without using built-in packages.
...
Within each project folder, a formal summary of the implementation and results can be found in "Report.pdf", 
and the rest of the files are either code or data.  
